...
function MenuPayrollManagement() {
  ...
  //   {
  //     name: "Salary Base",
  //     href: "/example1/salaryBase",
  //     icon: "",
  //   },
  //   {
  //     name: "Addition",
  //     href: "/example1/addition",
  //     icon: "",
  //   },
  //   {
  //     name: "Deduction",
  //     href: "/example1/deduction",
  //     icon: "",
  //   },
  // ];
  return (
    <div className="flex">
      <Link href="/example1/salaryBase">
        <div
          className={`shadow-md rounded-sm w-[18em] h-[7em] m-5 p-5 ml-10 cursor-pointer ${
            pathname == "/example1/salaryBase"
      ...
      <Link href="/example1/deduction">
        <div
          className={`shadow-md rounded-sm w-[18em] h-[7em] m-5 p-5 ml-10 cursor-pointer ${
            pathname == "/example1/deduction"
      ...
      <Link href="/example1/addition">
        <div
          className={`shadow-md rounded-sm w-[18em] h-[7em] m-5 p-5 ml-10 cursor-pointer ${
            pathname == "/example1/addition"
