    ...
    <div className="inline-block">
      ...
      <div className="flex items-stretch">
        <Link href="/shipping/chooseadd">
          <div className={`border rounded-lg inline-block w-[260px] h-[120px] mr-[20px] p-3 ${
              ...
              <label for="select" class="peer-checked/draft:text-sky-500 inline-block">
              <p className="font-bold text-lg">Choose your address</p>
              <p>Select your previosly saved address.</p>
              <p className="font-bold">You have 2 address now.</p>
            </label>
          </div>
        </Link>

        <Link href="/shipping/newadd">
          <div className={`border rounded-lg inline-block w-[260px] h-[120px] ${
              ...
              <input id="select" className="peer/draft inline-block border-2 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" type="radio" name="status" value="select"/>
              <label for="select" class="peer-checked/draft:text-sky-500 inline-block">
                <p className="font-bold font-bold text-lg">Add new address</p>
