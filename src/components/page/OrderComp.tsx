...
const Order = (props: Props) => {
  return (
    <>
      <div className="h-screen mt-8 p-10 ml-[70px] mr-[50px]  border-2 grid">
        <div className="flex mt-[30px] justify-self-center justify-center pb-[10px] w-[150px]">
          <p className="text-2xl font-bold">Your Order #000000</p>
        </div>
        <div className="border-t border-black w-[70px] justify-self-center block"></div>
        <div className="border-b-2 border-[#B7B7B7] h-8 flex flex-row mt-8 justify-between">
        ...
        <div className="border-b-2 border-[#B7B7B7] w-full pt-8 pb-4 flex flex-row justify-between  content-center">
          <div className="w-3/6 font-bold  flex flex-row">
            ...
            <div className="ml-6 flex flex-col justify-center">
              ...
              <p className="text-base text-[#A8A8A8] font-normal">By name</p>
            </div>
            {/* error: align center text */}
          </div>
          <p className="w-1/7 flex justify-center self-center ">50.00 ฿</p>
          <p className="w-1/7 flex justify-center self-center ">2</p>
          <p className="inline-block w-1/7 text-right font-bold self-center ">
            100.00 ฿
          </p>
        </div>
        ...
        <div className="w-[260px] my-8 ml-auto text-right">
          ...
          <Link href="/profile">
            <button className="rounded-md bg-[#F9BC60] text-[#FFFFFF] font-bold px-10 py-2">
              Back To Profile -&gt;
            </button>
          </Link>
        </div>
